...
SECRET_KEY = config(
    "SECRET_KEY",
    default="django-insecure-q3d)*opxw^#d4=h_kxer0dfco$^#8i1fc#3y8%@2kg^6po53r+",
)
...
DATABASES = {
    "default": dj_database_url.config(
        default=config(
            "DATABASE_URL",
            default="postgres://postgres:1234@localhost:5432/django_shop",
        )
    )
}
...
DEFAULT_FROM_EMAIL = config(
    "DEFAULT_FROM_EMAIL", default="test.testov.1999@internet.ru"
)
